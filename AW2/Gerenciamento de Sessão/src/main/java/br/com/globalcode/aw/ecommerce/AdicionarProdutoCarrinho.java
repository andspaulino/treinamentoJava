...
public class AdicionarProdutoCarrinho extends HttpServlet {
    ...
    private void adicionarProdutoCarrinho(HttpServletRequest request, Produto produtoSelecionado) {
        ...
        // -------------------------------------------------------------------
        //Obtendo obj HttpSession
        HttpSession httpSession = request.getSession();
        //Recuperando o atributo, com a aplicação do cast
        carrinho = (CarrinhoCompras) httpSession.getAttribute("carrinhoCompras");
        ...
        if (carrinho == null) { // se o carrinho de compras ainda não existe ...
            ...
            //Setar o atributo da session caso o carrinha esteja vazio
            httpSession.setAttribute("carrinhoCompras", carrinho);
